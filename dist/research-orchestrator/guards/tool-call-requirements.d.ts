...
export declare const TOOL_CALL_REQUIREMENTS: {
    ...
    readonly extract_page_content: {
        readonly anyOfPreviousTools: readonly ["brave_search", "exa_search", "serper_search", "tavily_search", "searxng_search", "youtube_search", "hacker_news_search", "aggregate_search"];
