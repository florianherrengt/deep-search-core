 ...
 */
export declare function createAggregateSearchTool(searchKeys: SearchKeys, fetchFn: typeof globalThis.fetch, options?: CreateAggregateSearchToolOptions): import("ai").Tool<{
    query: string;
}, string>;
